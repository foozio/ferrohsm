...
- JWT authentication improvements (cloud KMS integration, asymmetric verification, JWKS endpoint)
- Audit log integrity enhancements (hash-chain anchoring, checkpoint verification, key rotation)
- Dual-control workflow persistence (configurable quorum, approval APIs, audit summaries)
...
- PKCS#11 compatibility layer (fully implemented with conformance testing)
